...
![1](https://gw.alicdn.com/tfs/TB19y2QzKL2gK0jSZPhXXahvXXa-1562-160.jpg)
...
![](https://gw.alicdn.com/tfs/TB1eNnYzHj1gK0jSZFuXXcrHpXa-1804-162.jpg)
...
<table class="table table-bordered table-striped table-condensed">  
    ...
    <tr>  
        <td>Object</td>  
        <td> 1. primValue = ToPrimitive(input, String)
            <br>
...
<table class="table table-bordered table-striped table-condensed">  
    ...
    <tr>  
        <td>Object</td>  
        <td> 1. primValue = ToPrimitive(input,  Number)
            <br>
